...
function SportsCategories() {
  return (
    <section id="sports" className="py-16 bg-surface-secondary">
...
function MatchesSection() {
  return (
    <section id="matches" className="py-16 bg-surface-secondary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          <div>
...
function WhyChooseSection() {
  ...
  return (
    <section id="why" className="py-16 bg-surface-secondary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl md:text-3xl font-bold text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="#courts" className="hover:text-accent transition-colors">
                  Tìm sân
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#sports" className="hover:text-accent transition-colors">
                  Môn thể thao
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/register/owner" className="hover:text-accent transition-colors">
                  Đăng ký sân
                </Link>
              </li>
              <li>
